...
<?php
echo '<p class="h2 text-center text-primary mb-5">Edit Your Bio Data</p>';
?>

<?php

$query = "SELECT full_name, birth_year FROM biodata WHERE username = '$username'";
...
<form action="" method="post">
    <div class="mb-3">
        ...
        <input type="text" name="full_name" value="<?php echo $fname; ?>" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="birth_year" value="<?php echo $byear; ?>" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <input type="submit" value="Finally, Edit Your Biodata" class="btn btn-primary">
</form>
